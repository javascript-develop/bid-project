...
const uri = "mongodb+srv://websiteaccess2018:DZJPrVRbY3KyjbDl@cluster0.yjhzd1b.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0";
...
app.get("/", (req, res) => {
    res.send(" Your server is Running",port);
  });
  app.listen(port, () => {
